  ...
  return (<div className='min-h-screen bg-cream text-charcoal overflow-hidden'>
    <AnimatePresence mode='wait'>
      ...
      {route==='home' && (<motion.div key='home' {...fade} className='flex flex-col items-center justify-center p-12 space-y-10 text-center'>
        ...
        <motion.video initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.5}} src='/intro.mp4' className='w-full max-w-4xl rounded-xl shadow-xl border border-soft-green' autoPlay onEnded={goToExplore}/>
      </motion.div>)}
